...
describe('zipfile', function() {
  it('should be under 150kb', function() {
    var zip = fs.statSync('MBA_FedCivillian_D_640x480_HTML.zip');
...
describe('static image', function() {
  it('should match dimensions of the creative', function() {
    ...
    expect(dimensions.width).toBe(
      640,
      '\nIncorrect width on the static image. It should be 640px wide'
    );
    expect(dimensions.height).toBe(
      480,
      '\nIncorrect height on the static image. It should be 480px tall'
    );
  });
});
